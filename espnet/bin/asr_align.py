...
def main(args):
    ...
    parser.add_argument('--result-label', type=str, required=False,
                        help='Filename of result label data (json)')
    parser.add_argument('--align-json', type=str, required=True,
                        help='Filename of forced alignment label data (json)')
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            from espnet.asr.pytorch_backend.asr import align
            align(args)
        else:
