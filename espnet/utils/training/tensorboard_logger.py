...
class TensorboardLogger(Extension):
    ...
    def __init__(self, logger, att_reporter=None, entries=None, epoch=0, num_targets=1):
        """Init the extension
    ...
    def __call__(self, trainer):
        ...
        if self._att_reporter is not None and trainer.updater.get_iterator('main').epoch > self._epoch:
            ...
            [self._att_reporter.log_attentions(self._logger, trainer.updater.iteration, target) for target in range(self._num_targets)]
