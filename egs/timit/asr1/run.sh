...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    for set in ${train_set} ${train_dev} test; do
        merge_target_jsons.py --input-jsons ${dumpdir}/${set}/delta${do_delta}/data_phn.json ${dumpdir}/${set}/delta${do_delta}/data_char.json --output-json ${dumpdir}/${set}/delta${do_delta}/data.json 
    done
fi
